...
class Order(models.Model):
    ...
    class StatusChoices(models.TextChoices):
        PENDING = 'Pending' # Define a status choice for pending orders
        CONFIRMED = 'Confirmed'  # Define a status choice for confirmed orders
        CANCELLED = 'Cancelled' # Define a status choice for cancelled orders
